...
//
var edButtons=new Array(),extendedStart=edButtons.length;
edButtons.push(new edButton('ed_strong','b','<strong>','</strong>','b'));
edButtons.push(new edButton('ed_em','i','<em>','</em>','i'));
edButtons.push(new edButton('ed_link','link','','</a>','a'));
edButtons.push(new edButton('ed_block','b-quote','<blockquote>','</blockquote>','q'));
edButtons.push(new edButton('ed_pre','code','`','`','c'));
